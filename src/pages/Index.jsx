...
const Index = () => {
  ...
  const handleTweetPost = () => {
    ...
    const newTweet = {
      ...
      avatarUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHx1c2VyJTIwYXZhdGFyfGVufDB8fHx8MTcxMjM4MzU2Mnww&ixlib=rb-4.0.3&q=80&w=1080',
    };
